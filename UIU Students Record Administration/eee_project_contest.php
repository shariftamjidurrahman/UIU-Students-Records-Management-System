Records Management System<html>
	<head>
		<meta charset="utf-8">
		...
		<style>
			...
			.eeethesiscontestsection:hover
			{
             background-color: #A9A9A9;

             }
			 .eeethesiscontestarticle
			 {
				background-color: #D3D3D3;
				color:#000000;
			 }
			 .eeethesiscontestarticle:hover
			{
             background-color: #FF8C00;
			}
			footer
	...
	<body>
		<header>
				...
				<h2>
					<div align="center">EEE Project Contest</div>
					<div align="right">
		...
		<div class="w3-container">
			<nav>
				<ul>
					...
					<div class="btn-group-vertical" >
					<a class="btn btn-primary eeethesiscontestsection" onclick="openCity('Networking')">Networking</a>
					<a class="btn btn-primary eeethesiscontestsection" onclick="openCity('Electronics')">Electronics</a>
					<a class="btn btn-primary eeethesiscontestsection" onclick="openCity('Robotics')">Robotics</a>
					</div>
				</ul>
			</nav>
			<section>
				<h1>About EEE Project Contest</h1>
				...
				<div id="Networking" class="w3-container city" style="display:none">
					<article>
						<h1>About EEE Networking Project Contest</h1>
				...
				<div id="Robotics" class="w3-container city" style="display:none">
					<article>
						<h1>About EEE Robotics Project Contest</h1>
				...
				<div id="Electronics" class="w3-container city" style="display:none">
					<article>
						<h1>About EEE Electronics Project Contest</h1>
